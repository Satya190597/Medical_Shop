...
/* CREATE BILL TABLE FOR CUSTOMER */
CREATE TABLE BILL (
BILL_ID INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
CUSTOMER_NAME VARCHAR(75) NOT NULL,
CUSTOMER_CONTACT VARCHAR(50),
CUSTOMER_PAYMENT_MODE VARCHAR(25) NOT NULL,
CUSTOMER_TOTAL_AMOUNT FLOAT NOT NULL DEFAULT 0,
CUSTOMER_PAID_AMOUNT FLOAT NOT NULL DEFAULT 0,
CREATED_AT TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
